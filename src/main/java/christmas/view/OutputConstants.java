...
public class OutputConstants {
    ...
    public static final String SERVICE_BENEFIT = "증정이벤트: -%s원";
    public static final String EVENT_PREVIEW_MESSAGE = "12월 %s일에 우테코 식당에서 받을 이벤트 혜택 미리 보기!";
    public static final String ORDER_MENU_MESSAGE = "<주문 메뉴>";
    public static final String TOTAL_ORDER_AMOUNT = "<할인 전 총주문 금액>";
    public static final String SERVICE_MENU_MESSAGE = "<증정 메뉴>";
    public static final String BENEFIT_MESSAGE = "<혜택 내역>";
    public static final String TOTAL_BENEFIT_MESSAGE = "<총혜택 금액>";
    public static final String EXPECT_PAYMENT_AMOUNT_MESSAGE = "<할인 후 예상 결제 금액>";
